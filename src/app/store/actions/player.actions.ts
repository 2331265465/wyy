...
export const SetPlaying = createAction('[player] Set player', props<{ playing: boolean }>());
...
export const SetCurrentAction = createAction('[player] Set currentActions', props<{ currentAction: CurrentActions }>());
